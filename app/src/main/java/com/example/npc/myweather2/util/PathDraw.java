...
public class PathDraw extends View {
    ...
    public PathDraw(Context context, AttributeSet attr) {
        super(context, attr);
        this.c = context;
        init();
    }
    private void init(){
        ...
        mLinePaint1.setStyle(Paint.Style.FILL);
...
//        int h3 = (int) (h - fontHeight - SyncStateContract.Constants.picSize);
